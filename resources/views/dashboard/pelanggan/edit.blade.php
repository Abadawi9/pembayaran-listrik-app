    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('pelanggans.update', $pelanggan->id) }}" method="POST" role="form" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                        placeholder="Nama Pelanggan" value="{{ old('nama', $pelanggan->nama) }}" name="nama">
                            ...
                            <div class="col-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('alamat') is-invalid @enderror"
                                        id="alamat" placeholder="Alamat Pelanggan" value="{{ old('alamat', $pelanggan->alamat) }}"
                                        name="alamat">
                            ...
                            <div class="col-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('no_telp') is-invalid @enderror"
                                        id="no_telp" placeholder="NO Telp Pelanggan" value="{{ old('no_telp', $pelanggan->no_telp) }}"
                                        name="no_telp">
                            ...
                            <div class="col-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('no_meter') is-invalid @enderror"
                                        id="no_meter" placeholder="NO Meter Pelanggan" value="{{ old('no_meter', $pelanggan->no_meter) }}"
                                        name="no_meter">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('tarif_id') is-invalid @enderror" id="tarif_id" name="tarif_id">
                                        ...
                                        @foreach ($tarif as $tr)
                                            <option value="{{ $tr->id }}" @if (old('tarif_id', $pelanggan->tarif->id) == $tr->id) selected @endif>
                                                {{ $tr->daya }}</option>
                                        @endforeach
                                    </select>
